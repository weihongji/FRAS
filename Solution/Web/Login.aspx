...
<head runat="server">
	...
	<script type="text/javascript">
		...
		function window_onload() {
			if (top.window != window) { // Navigator the top page to login as well if the login page is opened in a frame.
				top.window.document.location.href = "<%=ResolveUrl("~/Login.aspx")%>";
				return;
			}
			document.getElementById("txtUserCode").focus();
		}
